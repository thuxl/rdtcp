...
uint32_t MaxBytesPerApp[] = {10 * 1024 * 1024,   32 * 1024,   32 * 1024,   32 * 1024,   32 * 1024};
  ...
  for (uint32_t i=0;i<NumberofEndPoints;i++)
  {
    ...
    if (i % NodesPerApp == 0)
    {
      ...
      //{
        ...
        delay.push_back(MilliSeconds (0)); //for incast, the first app is at 10ms, not 0ms.
        delay_prev = delay[j];
        j++;
      //}
